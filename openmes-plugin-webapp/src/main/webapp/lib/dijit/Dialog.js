...
_2.forEach([this.domNode,this.containerNode,this.titleBar],function(_2b){
...
var _2d=_1b.marginBox2contentBox(this.domNode,dim),_2e={domNode:this.containerNode,region:"center"};
_1b.layoutChildren(this.domNode,_2d,[{domNode:this.titleBar,region:"top"},_2e]);
if(this._singleChild){
...
_2.forEach(this.getChildren(),function(_2f){
if(_2f.resize){
_2f.resize();
}
});
...
if(_e("dojo-bidi")){
_1e=_4("dijit._DialogBase",_1e,{_setTitleAttr:function(_30){
this._set("title",_30);
this.titleNode.innerHTML=_30;
this.applyTextDir(this.titleNode);
},_setTextDirAttr:function(_31){
if(this._created&&this.textDir!=_31){
this._set("textDir",_31);
this.set("title",this.title);
}
}});
}
var _32=_4("dijit.Dialog",[_1a,_1e],{});
_32._DialogBase=_1e;
var _20=_32._DialogLevelManager={_beginZIndex:950,show:function(_33,_34){
ds[ds.length-1].focus=_12.curNode;
var _35=ds[ds.length-1].dialog?ds[ds.length-1].zIndex+2:_32._DialogLevelManager._beginZIndex;
_9.set(_33.domNode,"zIndex",_35);
_19.show(_34,_35-1);
ds.push({dialog:_33,underlayAttrs:_34,zIndex:_35});
},hide:function(_36){
if(ds[ds.length-1].dialog==_36){
ds.pop();
...
if(_36.refocus){
var _37=pd.focus;
if(pd.dialog&&(!_37||!_6.isDescendant(_37,pd.dialog.domNode))){
pd.dialog._getFocusItems();
_37=pd.dialog._firstFocusItem;
}
if(_37){
try{
_37.focus();
...
var idx=_2.indexOf(_2.map(ds,function(_38){
return _38.dialog;
}),_36);
if(idx!=-1){
ds.splice(idx,1);
...
return ds[ds.length-1].dialog==_39;
}};
var ds=_32._dialogStack=[{dialog:null,focus:null,underlayAttrs:null}];
_12.watch("curNode",function(_3a,_3b,_3c){
var _3d=ds[ds.length-1].dialog;
if(_3c&&_3d&&!_3d._fadeOutDeferred&&_3c.ownerDocument==_3d.ownerDocument){
do{
if(_3c==_3d.domNode||_7.contains(_3c,"dijitPopup")){
return;
}
}while(_3c=_3c.parentNode);
_3d.focus();
}
});
if(_e("dijit-legacy-requires")){
_d(0,function(){
var _3e=["dijit/TooltipDialog"];
_1(_3e);
});
}
return _32;
